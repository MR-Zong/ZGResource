...
///交互动画
@property(nonatomic,strong) SeaPresentInteractiveTransition *interativeTransition;
...
- (void)handlePan:(UIScreenEdgePanGestureRecognizer*) pan
{
    if(pan.state == UIGestureRecognizerStateBegan)
    {
        ...
        self.interativeTransition = interactive;
...
- (CGFloat)percentForGesture:(UIScreenEdgePanGestureRecognizer *)gesture
{
    ...
    return gesture.edges == UIRectEdgeLeft ? point.x / width : (width - point.x) / width;
}
