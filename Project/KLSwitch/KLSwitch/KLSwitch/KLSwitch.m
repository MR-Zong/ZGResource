...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.titleLabel.text = @"赏";
        CGFloat titleLabelWidth = 20;
        CGFloat titleLabelHeight = 20;
        self.titleLabel.frame = CGRectMake((frame.size.width - titleLabelWidth) / 2.0, (frame.size.height - titleLabelHeight) / 2.0, titleLabelWidth, titleLabelHeight);
