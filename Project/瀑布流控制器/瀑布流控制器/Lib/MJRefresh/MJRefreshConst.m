...
const CGFloat MJRefreshFastAnimationDuration = 1.25;
const CGFloat MJRefreshSlowAnimationDuration = 1.4;

NSString *const MJRefreshBundleName = @"MJRefresh.bundle";

NSString *const MJRefreshFooterPullToRefresh = @"ST上拉加载";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开立即加载";
NSString *const MJRefreshFooterRefreshing = @"MJ我草你妈正在加载数据...";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉可以刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即刷新";
NSString *const MJRefreshHeaderRefreshing = @"MJ我草你妈正在刷新...";
